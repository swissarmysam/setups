...
},{"./base":"node_modules/airtable/lib/base.js","./record":"node_modules/airtable/lib/record.js","./table":"node_modules/airtable/lib/table.js","./airtable_error":"node_modules/airtable/lib/airtable_error.js"}],"src/js/connect.js":[function(require,module,exports) {
"use strict";
...
var BASE = _airtable.default.base('appPcyzllmbSK5ir4');

var _default = BASE;
exports.default = _default;
},{"airtable":"node_modules/airtable/lib/airtable.js"}],"src/js/handlers.js":[function(require,module,exports) {
"use strict";
...
var innerContentGrid = contentGrid.querySelector('.columns');
exports.innerContentGrid = innerContentGrid;
var navBurger = document.querySelector('.navbar-burger');
exports.navBurger = navBurger;
var navBurgerMenu = document.querySelector('.navbar-menu');
...
function createHTML(rec) {
  ...
  if (page === 'index') {
    console.log(rec);
    var _ref = [rec.id, rec.fields.Pictures[0].url, rec.fields['Setup Category']],
        id = _ref[0],
        photo = _ref[1],
        categories = _ref[2];
    html = "<div class=\"column setup__img is-one-quarter\" data-id='".concat(id, "' data-categories='").concat(categories.join(' '), "'><a href='views/setup.html?id=").concat(id, "'><img class=\"photo\" src='").concat(photo, "' loading='lazy'></a></div>");
  } else {
    var _ref2 = [rec.fields.Name, rec.fields.Pictures[0].url, rec.fields['Personal Website'], rec.fields['Twitter Username'], rec.fields['Setup Category'], rec.fields['Item List']],
        name = _ref2[0],
        _photo = _ref2[1],
        website = _ref2[2],
        twitter = _ref2[3],
...
function insertContentOnPage(setups) {
  if (_typeof(setups) === 'object') {
    setups.forEach(function (setup) {
      _handlers.innerContentGrid.innerHTML += setup;
    });
  } else {
    var fragment = document.createRange().createContextualFragment(setups);

    _handlers.contentGrid.appendChild(fragment);
  }
}
...
var getSetups = {
  all: function all() {
    var allSetups = [];
    (0, _connect.default)('Form').select().eachPage(function page(records, fetchNextPage) {
  ...
  single: function single(id) {
    (0, _connect.default)('Form').find(id, function (err, record) {
      if (err) console.log({
        err: err
      });
...
},{"./connect":"src/js/connect.js","./handlers":"src/js/handlers.js"}],"src/js/events.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.handleBurgerMenu = handleBurgerMenu;
exports.filterOptions = filterOptions;

var _handlers = require("./handlers");

function handleBurgerMenu() {
  _handlers.navBurger.classList.toggle('is-active');

  _handlers.navBurgerMenu.classList.toggle('is-active');
}
...
},{"./handlers":"src/js/handlers.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _renderContent = require("./src/js/renderContent");

var _handlers = require("./src/js/handlers");

var _events = require("./src/js/events");

var queryParams = new URLSearchParams(window.location.search);

if (!queryParams.has('id')) {
  _renderContent.getSetups.all();
} else {
  _renderContent.getSetups.single(queryParams.get('id'));
} // EVENT LISTENERS


_handlers.navBurger.addEventListener('click', _events.handleBurgerMenu);

_handlers.categoryTag.forEach(function (tag) {
  tag.addEventListener('click', function () {
    return (0, _events.filterOptions)(tag.dataset.category);
  });
});
},{"./src/js/renderContent":"src/js/renderContent.js","./src/js/handlers":"src/js/handlers.js","./src/js/events":"src/js/events.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
